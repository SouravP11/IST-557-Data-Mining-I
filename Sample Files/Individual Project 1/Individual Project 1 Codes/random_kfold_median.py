...
for column in zero_not_accepted:
    ...
    median = int(my_train_df[column].median(skipna=True))
    my_train_df[column] = my_train_df[column].replace(np.NaN, median)
...
submission_df.to_csv("random_forest_val11_median.csv", index=False)
