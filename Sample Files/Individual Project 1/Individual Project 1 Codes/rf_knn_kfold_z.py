...
# Create an instance of the KNNImputer with the desired number of neighbors (e.g., 5)
knn_imputer = KNNImputer(n_neighbors=5)

# Perform KNN imputation for the "Cholesterol" column
my_train_df["Cholesterol"] = knn_imputer.fit_transform(my_train_df[["Cholesterol"]])
...
k = 5  # You can choose the number of folds (e.g., 5 for 5-fold cross-validation)
...
submission_df.to_csv("rf_knn_kfold_z.csv", index=False)
