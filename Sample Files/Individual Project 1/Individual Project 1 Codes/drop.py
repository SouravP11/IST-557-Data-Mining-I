...
# Replace zeroes
columns_to_drop_na = ["Cholesterol"]
my_train_df[columns_to_drop_na] = my_train_df[columns_to_drop_na].replace(0, np.NaN)
my_train_df.dropna(subset=columns_to_drop_na, inplace=True)
...
submission_df.to_csv("drop.csv", index=False)
